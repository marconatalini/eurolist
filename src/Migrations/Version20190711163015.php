 ...
 */
final class Version20190711163015 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE articolo (id INT AUTO_INCREMENT NOT NULL, classe_id INT DEFAULT NULL, codice VARCHAR(13) NOT NULL, descrizione VARCHAR(254) DEFAULT NULL, um VARCHAR(15) DEFAULT NULL, INDEX IDX_785868378F5EA509 (classe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE classe (id INT AUTO_INCREMENT NOT NULL, codice VARCHAR(13) NOT NULL, descrizione VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
